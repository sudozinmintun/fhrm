                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="input-group">
                                                                <input id="ctrl-message_date" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['message_date']; ?>" type="datetime" name="message_date" placeholder="Enter Message Date" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
